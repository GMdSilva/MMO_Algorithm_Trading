...
class Performance:
    ...
    def calculates_sale_offset(self, arb_bids, arb_asks):
        self.bids_successes = arb_bids
        self.asks_successes = arb_asks
    ...
    def update_performance_markers(self, arb_bids, arb_asks):
        self.calculates_sale_offset(arb_bids, arb_asks)
